...
melted_iris <- within(melted_iris, {
  # strsplit(Measurement.Type,split='[.]') will create a list of length nrow(melted_iris)
  # where each item in the list contains two elements: flower part and dimension
  # we'll store the flower parts in Flower.Part and dimensions in Dimension
